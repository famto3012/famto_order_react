...
const CheckoutPage = () => {
  ...
  const handleConfirmOrder = async () => {
    ...
    try {
      ...
      navigate("/order-confirm", { state: { confirmationData: result, orderType } });
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-white px-4 py-6 md:px-10 max-w-3xl mx-auto space-y-6">
      <h1 className="text-2xl font-semibold text-center text-teal-600">
        Checkout
      </h1>
      ...
      <div className="flex justify-center gap-4">
        <button
          className={`px-18 py-2 rounded-full font-medium border ${
