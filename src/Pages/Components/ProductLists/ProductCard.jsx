...
//     setCart((prev) => {
//       const updated = { ...prev };
//       if (quantity <= 1) delete updated[product.productId];
//       else updated[product.productId] -= 1;
//       return updated;
//     });
...
//                 <button className="text-red-600 text-xl font-bold" onClick={decrement}>−</button>
//                 <span className="font-semibold">{quantity}</span>
//                 <button className="text-green-600 text-xl font-bold" onClick={increment}>＋</button>
//               </div>
//             ) : (
//               <button
...
//                 onClick={product.variantAvailable ? customize : increment}
//               >
...
//             <h2 className="text-xl font-semibold pt-8">{product.productName}</h2>
//             <div className={`w-3 h-3 rounded-full ${product.type === "Veg" ? "bg-green-500" : "bg-red-500"}`} />
//           </div>
...
//                   <h2 className="text-green-600 font-semibold">₹ {product.discountPrice}</h2>
//                 </>
//               ) : (
...
//               <button onClick={() => setShowDialog(false)} className="text-gray-500 hover:text-black">✕</button>
//             </div>
...
//               </ul>
//             ) : (
//               <p className="text-center text-sm text-gray-500">No variants available</p>
//             )}
//           </div>
//         </div>
//       )}
        ...
        <div className="relative w-full md:w-52 h-40">
          ...
          {product.inventory ? (
            quantity > 0 ? (
              ...
              <button
                className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-[#00CED1] text-white px-10 py-1 text-sm rounded-full shadow-lg"
                onClick={product.variantAvailable ? customize : () => addToCart(product)}
              >
                {product.variantAvailable ? "Customize" : "Add"}
              </button>
            )
