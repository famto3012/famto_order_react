...
import { confirmCustomOrder } from "../../services/Custom_Order/customOrderService";
...
const SURGE_CHARGE = 30;
const WAITING_CHARGE = 40;
const DISCOUNT = 10;
const TAX = 20;
...
const CustomCheckout = ({ cartItems = [], cartId }) => {
    ...
    const grandTotal =
        DELIVERY_CHARGE + SURGE_CHARGE + WAITING_CHARGE + selectedTip + TAX - DISCOUNT;
    ...
    return (
        <div className="checkout-box">
            ...
            <div className="bill-summary flex flex-col">
                <h5>Bill Summary</h5>
                <div className="bill-row"><span>Item Total</span><span>will be updated soon</span></div>
                <div className="bill-row"><span>Delivery Charges</span><span>₹ {DELIVERY_CHARGE}</span></div>
                <div className="bill-row"><span>Surge Charges</span><span>₹ {SURGE_CHARGE}</span></div>
                <div className="bill-row"><span>Waiting Charges</span><span>₹ {WAITING_CHARGE}</span></div>
                <div className="bill-row"><span>Tip</span><span>₹ {selectedTip}</span></div>
                <div className="bill-row"><span>Discount (Promo Code)</span><span>-₹ {DISCOUNT}</span></div>
                <div className="bill-row"><span>Taxes & Fees</span><span>₹ {TAX}</span></div>
